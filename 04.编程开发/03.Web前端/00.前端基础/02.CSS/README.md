...
[伪类 | MDN](https://developer.mozilla.org/zh-CN/docs/Web/CSS/Pseudo-classes#标准伪类索引) 常用：
...
![image-20230607133604343](README.assets/image-20230607133604343.png)
...
![image-20230607133749455](README.assets/image-20230607133749455.png)

![image-20230607133802457](README.assets/image-20230607133802457.png)
...
![image-20230607134726429](README.assets/image-20230607134726429.png)

2. 当一个元素在另一个元素中时，它们的顶边距和低边距也会发生叠加

![image-20230607134745050](README.assets/image-20230607134745050.png)

3. 如果一个元素是空元素（即一个元素没有内容，内边距和边框），这种情况外边距的顶边距和低边距碰在一起也会发生叠加

![image-20230607134804640](README.assets/image-20230607134804640.png)

4. 在上面那种空元素的情况，如果该空元素与另一个元素的外边距碰在一起，也会发生叠加。

![image-20230607134828877](README.assets/image-20230607134828877.png)

以上 4 种外边距叠加情况**只会发生在普通文档流的垂直方向**。行内框、浮动框、绝对定位框之间的外边距不会发生叠加，同样水平方向也不会发生叠加。

## 参考链接

https://github.com/huyaocode/webKnowledge/blob/master/0-%E5%89%8D%E7%AB%AF%E5%9F%BA%E7%A1%80/CSS/README.md
